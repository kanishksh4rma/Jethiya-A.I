...
░╚════╝░╚══════╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░░╚═╝░░░╚═╝░░╚═╝░░░░░░╚═╝░░╚═╝╚═╝╚═╝
    ...
    def buildModel(self,epochs,vocab_size,max_len):
      ...
      # so far.
      model.fit(padded_sequences, np.array(training_labels), epochs=epochs, callbacks=[model_checkpoint_callback])
    ...
    def test(self,input_lst,output):
      ...
      self.buildModel(epochs=2400,vocab_size=1000,max_len=25)
      # load trained model
...
if __name__ == '__main__':
    ...
    babuchakEngine.buildModel(epochs=2400,vocab_size=1000,max_len=25)
